...
if(this.mhealth===800){
  if(this.health<=400){
    ...
    if(this.health%40==0){
      ...
      enem.push(new Enemy(vpos,140,0.6,this.x-50));
      penem.push(vpos);
      enem.push(new Enemy(vpos,140,0.6,this.x+100));
      penem.push(vpos);
        this.y=vpos;
        penem.push(vpos);
      tp=1}
...
draw(){
  if(this.mhealth===800){ctx.drawImage(lick,this.x,this.y,100,100);
