...
else if(e.key==='Enter' && win===1){window.location.href="boss1.html"}
})
...
if(frame%ienem===0 && score<winningscore){
  ...
  if(frame<4000){enem.push(new Enemy(vpos,100,0.4));}
    ...
    else if(frame>6000 &&frame<8000){enem.push(new Enemy(vpos,200,0.6));
    

  }
  else if(frame>=8000){enem.push(new Enemy(vpos,200,0.9))}
